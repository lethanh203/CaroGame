...
public class play1 extends JFrame implements ActionListener {
	...
	public play1(String a, String b) {
		super();
		init1();
		n1 = a;
		n2 = b;
	...
	public void actionPerformed(ActionEvent e) {
		if ("Xin thua".equalsIgnoreCase(e.getActionCommand())) {
			if (ng % 2 == 0) {
				new end1(n1, n2, n1).setVisible(true);
			} else {
				new end1(n1, n2, n2).setVisible(true);
			}
			this.dispose();
		}
		if ("Choi lai".equalsIgnoreCase(e.getActionCommand())) {
			new play1(n1, n2).setVisible(true);
			this.dispose();
		}
